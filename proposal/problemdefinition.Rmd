...
across antimeridian (180 degree West) and poles.
...
operations it can be implemented much more robustly
...
It should also be tackled because it _can_ be tackled: the library empowering these modern systems, [s2geometry](https://s2geometry.io/), is open source, well maintained and documented, and [can be ported to R](https://cran.r-project.org/web/packages/s2/index.html).
